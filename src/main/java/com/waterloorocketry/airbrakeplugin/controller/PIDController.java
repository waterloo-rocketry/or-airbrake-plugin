...
public class PIDController implements Controller {
    ...
    TrajectoryPrediction expectedAltitude = new TrajectoryPrediction(0, 0, 0, 0);
    ...
    public double calculateTargetExt(double[] flightData, double time) {
        expectedAltitude.updateInstance(flightData[4], flightData[1], 0.5, 39.564);
        double altitude = expectedAltitude.get_max_altitude();
